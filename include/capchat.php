...
$polices = Array('arial'); //Pensez à en rajouter !!
...
while($i <= 7)
{
	...
	imagettftext($image, $taille, $angle, $ecart*$i+15, $y, $aupifcolor, './polices/3Dumb-fontfacekit/web_fonts/3dumb_regular_macroman/3Dumb-webfont.ttf', $lettre);
	$i++;
}

imagepng($image); //On envoie et on prie :p
//print_r ($_SESSION['captcha']) à comparer avec la variable $_post['capchat'};
